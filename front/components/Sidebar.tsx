          ...
          <li>
            <Link
              ...
              className={`w-full flex items-center px-4 py-3 my-1 rounded-lg text-sm font-medium transition-colors duration-200 relative ${
                ...
                location.pathname === '/export-preview'
                  ? 'bg-slate-900 text-white'
                  : 'text-slate-400 hover:bg-slate-700 hover:text-white'
              }`}
              title={isCollapsed ? 'Export PDF' : undefined}
              aria-current={location.pathname === '/export-preview' ? 'page' : undefined}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
              {!isCollapsed && <span className="ml-3 whitespace-nowrap">Export PDF</span>}
            </Link>
          </li>
        </ul>
      </nav>
