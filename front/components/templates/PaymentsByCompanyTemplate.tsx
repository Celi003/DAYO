...
export const PaymentsByCompanyTemplate: React.FC<Props> = ({
  provider = '',
  reportType = 'État de facturation par compagnie',
  companyName = '',
  period = '',
  exportedAt = '',
  totals,
    ...
    <div style={styles.container} className="template-root">
      <div style={styles.headerRow} className="template-header">
        <div style={styles.headerBlock}>
          ...
          <div>{reportType}</div>
          <div style={{ height: 8 }} />
          <div style={styles.smallLabel}>Compagnie :</div>
          <div>{companyName}</div>
        </div>
      ...
      <table style={styles.bigTable} className="template-table">
        <thead>
            ...
            <th style={{ ...styles.th, textAlign: 'center' }}>Compagnie</th>
        ...
        <tbody>
          {rows.map((r, i) => {
            ...
            return (
              <tr>
              <td style={styles.tdCenter}>{r.invoiceNumber}</td>
              <td style={styles.tdCenter}>{r.depositDate}</td>
              <td style={styles.tdCenter}>{r.invoiceMonth}</td>
              <td style={styles.tdCenter}>{r.company}</td>
...
export default PaymentsByCompanyTemplate
