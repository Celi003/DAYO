...
SECRET_KEY = 'django-insecure-y)f9!)*q@52-e(p)pyhzmggmf@791p3uh^%d$k^rll094t+75h'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.onrender.com', 'dayo.vercel.app']
...
# EMAIL_HOST_PASSWORD = 'qdhx fwek oqrf bkpa'
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
...
CELERY_BEAT_SCHEDULE = {
    'check-subscription-expiry-every-day': {
        'task': 'backend.check_subscription_expiry',
